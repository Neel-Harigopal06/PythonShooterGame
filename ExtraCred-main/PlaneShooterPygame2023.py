#DEVELOPED BY NEEL HARIGOPAL, VEDIT SAIRI, SAMARTH SONI
import pygame 
import os #Imports from other folders
import math #For scrolling Backdrop
import random #Random integers/Enemy Positions
pygame.init() 
...
nazi1 = pygame.image.load(os.path.join('assets','badg.png'))
nazi2 = pygame.image.load(os.path.join('assets','badg.png'))
nazi3 = pygame.image.load(os.path.join('assets','badg.png'))
...
playership = pygame.transform.scale(pygame.image.load(os.path.join('assets','KyloRen.png')),(200,100))
...
bg = pygame.transform.scale(pygame.image.load(os.path.join('assets','Rock.png')),(winx,winy)).convert()
...
def main(): 
    ...
    def update_win():
        ...
        if gameover: 
                ...
                gameovertxt2 = gameover_font2.render("YOUR COUNTRY THANKS YOU FOR YOUR SACRIFICE" , 1 , (255,0,0))
    ...
    while run == True:
        ...
        if len(enemies) == 0 : 
            ...
            for i in range(wavetime): 
                enemy = Enemy(random.randrange(1600,4000),random.randrange(95, 400),random.choice(["enem1","enem2","enem3"]))
